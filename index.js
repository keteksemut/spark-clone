...
=============================================================*/
 ...
 const activeAnimationIds = new Map();
        ...
        function animateStroke(path) {
            ...
            if (!isFirefox) {
                const pathLength = getComputedStyle(document.documentElement).getPropertyValue('--stroke-length');
        ...
        function animateMorph(svg, path, initialCommands, targetCommands, delay, initialProgress, isTriggered, isPaused) {
            let startTime = null;
        ...
        function createAnimatedSvg(options) {
            ...
            if (isTriggered) {
                animateStroke(path);
                animateMorph(svg, path, initialCommands, targetCommands, delay, initialProgress, isTriggered, isPaused);
            }
